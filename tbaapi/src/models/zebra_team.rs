...
pub struct ZebraTeam {
    ...
    pub team_key: String,
    /// A list containing doubles and nulls representing a teams X position in
    /// feet at the corresponding timestamp. A null value represents no tracking
    /// data for a given timestamp.
    #[serde(rename = "xs")]
    pub xs: Vec<f64>,
    /// A list containing doubles and nulls representing a teams Y position in
    /// feet at the corresponding timestamp. A null value represents no tracking
    /// data for a given timestamp.
    #[serde(rename = "ys")]
    pub ys: Vec<f64>,
