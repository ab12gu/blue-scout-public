...
pub struct Match {
    ...
    /// competition level. A set number may be appended to the competition level
    ...
    /// The color (red/blue) of the winning alliance. Will contain an empty
    ...
    /// UNIX timestamp (seconds since 1-Jan-1970 00:00:00) of the scheduled
...
impl Match {
    pub fn new(
        ...
        set_number: i32,
        match_number: i32,
        alliances: models::MatchSimpleAlliances,
        ...
        score_breakdown: Option<models::MatchScoreBreakdown>,
        videos: Vec<models::MatchVideosInner>,
    ) -> Match {
        Match {
            key,
            comp_level,
            ...
            predicted_time,
            post_result_time,
            score_breakdown: if let Some(x) = score_breakdown {
                Some(Box::new(x))
            } else {
                None
            },
