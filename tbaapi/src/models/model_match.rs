...
pub struct Match {
    ...
    #[serde(rename = "score_breakdown", deserialize_with = "Option::deserialize")]
    pub score_breakdown: Option<Box<models::MatchScoreBreakdown>>,
...
impl Match {
    pub fn new(key: String, comp_level: CompLevel, set_number: i32, match_number: i32, alliances: models::MatchSimpleAlliances, winning_alliance: WinningAlliance, event_key: String, time: Option<i64>, actual_time: Option<i64>, predicted_time: Option<i64>, post_result_time: Option<i64>, score_breakdown: Option<models::MatchScoreBreakdown>, videos: Vec<models::MatchVideosInner>) -> Match {
        Match {
            key,
            comp_level,
            set_number,
            ...
            predicted_time,
            post_result_time,
            score_breakdown: if let Some(x) = score_breakdown {Some(Box::new(x))} else {None},
            videos,
        }
    }
}
