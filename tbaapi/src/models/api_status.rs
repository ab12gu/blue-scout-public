...
pub struct ApiStatus {
    ...
    #[serde(rename = "ios")]
    pub ios: Box<models::ApiStatusAppVersion>,
    #[serde(rename = "android")]
    pub android: Box<models::ApiStatusAppVersion>,
}

impl ApiStatus {
    pub fn new(current_season: i32, max_season: i32, is_datafeed_down: bool, down_events: Vec<String>, ios: models::ApiStatusAppVersion, android: models::ApiStatusAppVersion) -> ApiStatus {
        ApiStatus {
            current_season,
            max_season,
            is_datafeed_down,
