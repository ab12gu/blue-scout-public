...
/// EventInsights2018 : Insights for FIRST Power Up qualification and
/// elimination matches.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct EventInsights2018 {
    /// An array with three values, number of times auto quest was completed,
    ...
    /// An array with three values, number of times a boost power up was played,
    ...
    /// An array with three values, number of times a climb occurred, number of
    /// opportunities to climb, and percentage.
    #[serde(rename = "climb_counts")]
    pub climb_counts: Vec<f32>,
    /// An array with three values, number of times an alliance faced the boss,
    ...
    /// An array with three values, number of times a force power up was played,
    ...
    /// An array with three values, number of times a levitate power up was
    /// played, number of opportunities to play a levitate power up, and
    /// percentage.
    #[serde(rename = "levitate_played_counts")]
    pub levitate_played_counts: Vec<f32>,
    /// An array with three values, number of times a team scored mobility
    /// points in auto, number of opportunities to score mobility points in
    /// auto, and percentage.
    ...
    /// An array with three values, number of times a switch was owned during
    /// auto, number of opportunities to own a switch during auto, and
    /// percentage.
    #[serde(rename = "switch_owned_counts_auto")]
    pub switch_owned_counts_auto: Vec<f32>,
    /// An array with three values, number of times a unicorn match (Win + Auto
    /// Quest + Face the Boss) occurred, number of opportunities to have a
    /// unicorn match, and percentage.
    #[serde(rename = "unicorn_matches")]
    pub unicorn_matches: Vec<f32>,
    /// Average opposing switch denail percentage for the winning alliance
    /// during teleop.
    ...
    /// Average own switch ownership percentage for the winning alliance during
    /// auto.
    ...
    /// Average scale ownership percentage for the winning alliance during
    /// teleop.
