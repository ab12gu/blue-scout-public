...
/// MatchTimeseries2018 : Timeseries data for the 2018 game *FIRST* POWER UP.
/// *WARNING:* This is *not* official data, and is subject to a significant
/// possibility of error, or missing data. Do not rely on this data for any
/// purpose. In fact, pretend we made it up. *WARNING:* This model is currently
...
pub struct MatchTimeseries2018 {
    ...
    /// Match ID consisting of the level, match number, and set number, eg
    /// `qm45` or `f1m1`.
    #[serde(rename = "match_id", skip_serializing_if = "Option::is_none")]
    pub match_id: Option<String>,
    /// Current mode of play, can be `pre_match`, `auto`, `telop`, or
    /// `post_match`.
    #[serde(rename = "mode", skip_serializing_if = "Option::is_none")]
    pub mode: Option<String>,
    #[serde(rename = "play", skip_serializing_if = "Option::is_none")]
    pub play: Option<i32>,
    /// Amount of time remaining in the match, only valid during `auto` and
    /// `teleop` modes.
    ...
    /// Number of POWER CUBES in the LEVITATE section of the blue alliance
    /// VAULT.
    #[serde(
    ...
    /// Number of seconds remaining in the blue alliance POWER UP time, or 0 if
    /// none is active.
    #[serde(
    ...
    /// Number of seconds remaining in the red alliance POWER UP time, or 0 if
    /// none is active.
    #[serde(
...
impl MatchTimeseries2018 {
    /// Timeseries data for the 2018 game *FIRST* POWER UP. *WARNING:* This is
    /// *not* official data, and is subject to a significant possibility of
    /// error, or missing data. Do not rely on this data for any purpose. In
    /// fact, pretend we made it up. *WARNING:* This model is currently under
    /// active development and may change at any time, including in breaking
    /// ways.
