...
/// TeamEventStatusPlayoff : Playoff status for this team, may be null if the
/// team did not make playoffs, or playoffs have not begun.
...
pub struct TeamEventStatusPlayoff {
    ...
    /// The average match score during playoffs. Year specific. May be null if
    /// not relevant for a given year.
    #[serde(
        rename = "playoff_average",
        default,
        with = "::serde_with::rust::double_option",
        skip_serializing_if = "Option::is_none"
    )]
