...
pub struct Award {
    /// The name of the award as provided by FIRST. May vary for the same award
    /// type.
    #[serde(rename = "name")]
    pub name: String,
    ...
    /// A list of recipients of the award at the event. May have either a
    /// team_key or an awardee, both, or neither (in the case the award wasn't
    /// awarded at the event).
    #[serde(rename = "recipient_list")]
    pub recipient_list: Vec<models::AwardRecipient>,
...
impl Award {
    pub fn new(
        ...
        award_type: i32,
        event_key: String,
        recipient_list: Vec<models::AwardRecipient>,
        year: i32,
    ) -> Award {
        Award {
            name,
