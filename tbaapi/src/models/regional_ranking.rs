...
/// RegionalRanking : Rank of a team in the regional pool.
...
pub struct RegionalRanking {
    ...
    /// Additional points awarded in lieu of a second event, based on first
    /// event performance
    #[serde(rename = "single_event_bonus", skip_serializing_if = "Option::is_none")]
    pub single_event_bonus: Option<i32>,
    ...
    pub event_points: Option<Vec<models::RegionalRankingEventPointsInner>>,
}

impl RegionalRanking {
    /// Rank of a team in the regional pool.
    pub fn new(team_key: String, rank: i32, point_total: i32) -> RegionalRanking {
        RegionalRanking {
            team_key,
            rank,
            rookie_bonus: None,
            single_event_bonus: None,
            point_total,
            event_points: None,
        }
    }
