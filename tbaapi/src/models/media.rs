...
/// Media : The `Media` object contains a reference for most any media
/// associated with a team or event on TBA.
...
impl Media {
    /// The `Media` object contains a reference for most any media associated
