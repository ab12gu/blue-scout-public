...
pub struct MatchScoreBreakdown2020Alliance {
    ...
    /// Unofficial TBA-computed value that indicates whether the
    /// shieldEnergizedRankingPoint was earned normally or awarded due to a
    /// foul.
    #[serde(
    ...
    /// Unofficial TBA-computed value that counts the number of robots who were
