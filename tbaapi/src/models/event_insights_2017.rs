...
/// EventInsights2017 : Insights for FIRST STEAMWORKS qualification and
/// elimination matches.
...
pub struct EventInsights2017 {
    ...
    /// An array with three values, kPa scored, match key from the match with
    /// the high kPa, and the name of the match
    ...
    /// An array with three values, number of times kPa bonus achieved, number
    /// of opportunities to bonus, and percentage.
    #[serde(rename = "kpa_achieved")]
    pub kpa_achieved: Vec<f32>,
    /// An array with three values, number of times mobility bonus achieved,
    /// number of opportunities to bonus, and percentage.
    #[serde(rename = "mobility_counts")]
    pub mobility_counts: Vec<f32>,
    /// An array with three values, number of times rotor 1 engaged, number of
    /// opportunities to engage, and percentage.
    #[serde(rename = "rotor_1_engaged")]
    pub rotor_1_engaged: Vec<f32>,
    /// An array with three values, number of times rotor 1 engaged in auto,
    /// number of opportunities to engage in auto, and percentage.
    #[serde(rename = "rotor_1_engaged_auto")]
    pub rotor_1_engaged_auto: Vec<f32>,
    /// An array with three values, number of times rotor 2 engaged, number of
    /// opportunities to engage, and percentage.
    #[serde(rename = "rotor_2_engaged")]
    pub rotor_2_engaged: Vec<f32>,
    /// An array with three values, number of times rotor 2 engaged in auto,
    /// number of opportunities to engage in auto, and percentage.
    #[serde(rename = "rotor_2_engaged_auto")]
    pub rotor_2_engaged_auto: Vec<f32>,
    /// An array with three values, number of times rotor 3 engaged, number of
    /// opportunities to engage, and percentage.
    #[serde(rename = "rotor_3_engaged")]
    pub rotor_3_engaged: Vec<f32>,
    /// An array with three values, number of times rotor 4 engaged, number of
    /// opportunities to engage, and percentage.
    #[serde(rename = "rotor_4_engaged")]
    pub rotor_4_engaged: Vec<f32>,
    /// An array with three values, number of times takeoff was counted, number
    /// of opportunities to takeoff, and percentage.
    #[serde(rename = "takeoff_counts")]
    pub takeoff_counts: Vec<f32>,
    /// An array with three values, number of times a unicorn match (Win + kPa &
    /// Rotor Bonuses) occured, number of opportunities to have a unicorn match,
    /// and percentage.
