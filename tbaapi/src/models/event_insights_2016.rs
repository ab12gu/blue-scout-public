...
/// EventInsights2016 : Insights for FIRST Stronghold qualification and
/// elimination matches.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct EventInsights2016 {
    /// For the Low Bar - An array with three values, number of times damaged,
    ...
    /// For the Ramparts - An array with three values, number of times damaged,
    /// number of opportunities to damage, and percentage.
    #[serde(rename = "B_Ramparts")]
    pub b_ramparts: Vec<f32>,
    /// For the Moat - An array with three values, number of times damaged,
    /// number of opportunities to damage, and percentage.
    #[serde(rename = "B_Moat")]
    pub b_moat: Vec<f32>,
    ...
    /// For the Rock Wall - An array with three values, number of times damaged,
    /// number of opportunities to damage, and percentage.
    ...
    /// An array with three values, number of times breached, number of
    /// opportunities to breach, and percentage.
    #[serde(rename = "breaches")]
    pub breaches: Vec<f32>,
    /// An array with three values, number of times scaled, number of
    /// opportunities to scale, and percentage.
    #[serde(rename = "scales")]
    pub scales: Vec<f32>,
    /// An array with three values, number of times challenged, number of
    /// opportunities to challenge, and percentage.
    #[serde(rename = "challenges")]
    pub challenges: Vec<f32>,
    /// An array with three values, number of times captured, number of
    /// opportunities to capture, and percentage.
