...
pub struct GetTeamEventsStatusesByYear200ResponseValue {
    ...
    /// An HTML formatted string suitable for display to the user containing the
    ...
    /// An HTML formatter string suitable for display to the user containing the
    ...
    /// TBA match key for the next match the team is scheduled to play in at
    /// this event, or null.
    #[serde(
        rename = "next_match_key",
        default,
        with = "::serde_with::rust::double_option",
        skip_serializing_if = "Option::is_none"
    )]
    pub next_match_key: Option<Option<String>>,
    /// TBA match key for the last match the team played in at this event, or
    /// null.
    #[serde(
        rename = "last_match_key",
        default,
        with = "::serde_with::rust::double_option",
        skip_serializing_if = "Option::is_none"
    )]
