...
pub struct MatchScoreBreakdown2023Alliance {
    #[serde(
        rename = "activationBonusAchieved",
    ...
    #[serde(
        rename = "sustainabilityBonusAchieved",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    #[serde(
        rename = "teleopGamePieceCount",
        skip_serializing_if = "Option::is_none"
    )]
    pub teleop_game_piece_count: Option<i32>,
    #[serde(
        rename = "teleopGamePiecePoints",
        skip_serializing_if = "Option::is_none"
    )]
    pub teleop_game_piece_points: Option<i32>,
    #[serde(
        rename = "totalChargeStationPoints",
        skip_serializing_if = "Option::is_none"
    )]
