...
pub struct MatchScoreBreakdown2022Alliance {
    ...
    #[serde(
        rename = "cargoBonusRankingPoint",
        skip_serializing_if = "Option::is_none"
    )]
    pub cargo_bonus_ranking_point: Option<bool>,
    #[serde(
        rename = "hangarBonusRankingPoint",
        skip_serializing_if = "Option::is_none"
    )]
