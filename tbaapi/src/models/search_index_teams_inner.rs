...
pub struct SearchIndexTeamsInner {
    #[serde(rename = "key")]
    pub key: String,
...
impl SearchIndexTeamsInner {
    pub fn new(key: String, nickname: String) -> SearchIndexTeamsInner {
        SearchIndexTeamsInner { key, nickname }
    }
}
