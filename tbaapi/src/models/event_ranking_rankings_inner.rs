...
pub struct EventRankingRankingsInner {
    ...
    /// The average match score during qualifications. Year specific. May be
    /// null if not relevant for a given year.
    ...
    /// Additional year-specific information, may be null. See parent
...
impl EventRankingRankingsInner {
    pub fn new(
        matches_played: i32,
        qual_average: Option<i32>,
        extra_stats: Vec<f64>,
        sort_orders: Option<Vec<f64>>,
