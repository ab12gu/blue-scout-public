...
pub struct LeaderboardInsightData {
    ...
    /// What type of key is used in the rankings; either 'team', 'event', or
    /// 'match'.
...
impl LeaderboardInsightData {
    pub fn new(
        rankings: Vec<models::LeaderboardInsightDataRankingsInner>,
        key_type: KeyType,
    ) -> LeaderboardInsightData {
        LeaderboardInsightData { rankings, key_type }
    }
}
/// What type of key is used in the rankings; either 'team', 'event', or
/// 'match'.
