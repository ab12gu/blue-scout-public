...
pub struct Webcast {
    ...
    #[serde(rename = "type")]
    pub r#type: Type,
    /// Type specific channel information. May be the YouTube stream, or Twitch
    /// channel name. In the case of iframe types, contains HTML to embed the
    /// stream in an HTML iframe.
