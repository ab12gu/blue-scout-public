...
pub async fn get_match(configuration: &configuration::Configuration, match_key: &str) -> Result<models::Match, Error<GetMatchError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_match_key = match_key;

    let uri_str = format!("{}/match/{match_key}", configuration.base_path, match_key=crate::apis::urlencode(p_match_key));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_match_simple(configuration: &configuration::Configuration, match_key: &str) -> Result<models::MatchSimple, Error<GetMatchSimpleError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_match_key = match_key;

    let uri_str = format!("{}/match/{match_key}/simple", configuration.base_path, match_key=crate::apis::urlencode(p_match_key));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::MatchSimple`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::MatchSimple`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn get_match_timeseries(configuration: &configuration::Configuration, match_key: &str) -> Result<Vec<serde_json::Value>, Error<GetMatchTimeseriesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_match_key = match_key;

    let uri_str = format!("{}/match/{match_key}/timeseries", configuration.base_path, match_key=crate::apis::urlencode(p_match_key));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_match_zebra(configuration: &configuration::Configuration, match_key: &str) -> Result<models::Zebra, Error<GetMatchZebraError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_match_key = match_key;

    let uri_str = format!("{}/match/{match_key}/zebra_motionworks", configuration.base_path, match_key=crate::apis::urlencode(p_match_key));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::Zebra`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::Zebra`")))),
        }
    } else {
        let content = resp.text().await?;
