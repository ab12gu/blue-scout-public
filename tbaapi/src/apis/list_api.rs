...
/// Gets a list of `LeaderboardInsight` objects from a specific year. Use year=0
/// for overall.
pub async fn get_insights_leaderboards_year(
    configuration: &configuration::Configuration,
    year: i32,
) -> Result<Vec<models::LeaderboardInsight>, Error<GetInsightsLeaderboardsYearError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_year = year;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => {
                return Err(Error::from(serde_json::Error::custom(
                    "Received `text/plain` content type response that cannot be converted to `Vec&lt;models::LeaderboardInsight&gt;`",
                )));
            }
            ContentType::Unsupported(unknown_type) => {
                return Err(Error::from(serde_json::Error::custom(format!(
                    "Received `{unknown_type}` content type response that cannot be converted to `Vec&lt;models::LeaderboardInsight&gt;`"
                ))));
            }
        }
    } else {
...
/// Gets a list of `NotablesInsight` objects from a specific year. Use year=0
/// for overall.
pub async fn get_insights_notables_year(
    configuration: &configuration::Configuration,
    year: i32,
) -> Result<Vec<models::NotablesInsight>, Error<GetInsightsNotablesYearError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_year = year;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => {
                return Err(Error::from(serde_json::Error::custom(
                    "Received `text/plain` content type response that cannot be converted to `Vec&lt;models::NotablesInsight&gt;`",
                )));
            }
            ContentType::Unsupported(unknown_type) => {
                return Err(Error::from(serde_json::Error::custom(format!(
                    "Received `{unknown_type}` content type response that cannot be converted to `Vec&lt;models::NotablesInsight&gt;`"
                ))));
            }
        }
    } else {
...
pub async fn get_regional_advancement(
    configuration: &configuration::Configuration,
    year: i32,
) -> Result<
    std::collections::HashMap<String, models::RegionalAdvancement>,
    Error<GetRegionalAdvancementError>,
> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_year = year;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => {
                return Err(Error::from(serde_json::Error::custom(
                    "Received `text/plain` content type response that cannot be converted to `std::collections::HashMap&lt;String, models::RegionalAdvancement&gt;`",
                )));
            }
            ContentType::Unsupported(unknown_type) => {
                return Err(Error::from(serde_json::Error::custom(format!(
                    "Received `{unknown_type}` content type response that cannot be converted to `std::collections::HashMap&lt;String, models::RegionalAdvancement&gt;`"
                ))));
            }
        }
    } else {
...
pub async fn get_regional_rankings(
    configuration: &configuration::Configuration,
    year: i32,
) -> Result<Vec<models::RegionalRanking>, Error<GetRegionalRankingsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_year = year;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => {
                return Err(Error::from(serde_json::Error::custom(
                    "Received `text/plain` content type response that cannot be converted to `Vec&lt;models::RegionalRanking&gt;`",
                )));
            }
            ContentType::Unsupported(unknown_type) => {
                return Err(Error::from(serde_json::Error::custom(format!(
                    "Received `{unknown_type}` content type response that cannot be converted to `Vec&lt;models::RegionalRanking&gt;`"
                ))));
            }
        }
    } else {
