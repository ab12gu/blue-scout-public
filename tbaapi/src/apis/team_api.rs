...
pub async fn get_team(
    configuration: &configuration::Configuration,
    team_key: &str,
) -> Result<models::Team, Error<GetTeamError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => {
                return Err(Error::from(serde_json::Error::custom(
                    "Received `text/plain` content type response that cannot be converted to `models::Team`",
                )));
            }
            ContentType::Unsupported(unknown_type) => {
                return Err(Error::from(serde_json::Error::custom(format!(
                    "Received `{unknown_type}` content type response that cannot be converted to `models::Team`"
                ))));
            }
        }
    } else {
...
pub async fn get_team_awards(
    configuration: &configuration::Configuration,
    team_key: &str,
) -> Result<Vec<models::Award>, Error<GetTeamAwardsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_team_key = team_key;
...
pub async fn get_team_awards_by_year(
    configuration: &configuration::Configuration,
    team_key: &str,
    year: i32,
) -> Result<Vec<models::Award>, Error<GetTeamAwardsByYearError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_team_key = team_key;
    let p_year = year;
...
/// Gets the history for the team referenced by the given key, including their
/// events and awards.
pub async fn get_team_history(
    configuration: &configuration::Configuration,
    team_key: &str,
) -> Result<models::History, Error<GetTeamHistoryError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_team_key = team_key;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => {
                return Err(Error::from(serde_json::Error::custom(
                    "Received `text/plain` content type response that cannot be converted to `models::History`",
                )));
            }
            ContentType::Unsupported(unknown_type) => {
                return Err(Error::from(serde_json::Error::custom(format!(
                    "Received `{unknown_type}` content type response that cannot be converted to `models::History`"
                ))));
            }
        }
    } else {
...
pub async fn get_team_media_by_tag(
    configuration: &configuration::Configuration,
    team_key: &str,
    media_tag: &str,
) -> Result<Vec<models::Media>, Error<GetTeamMediaByTagError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_team_key = team_key;
    ...
    let uri_str = format!(
        ...
        configuration.base_path,
        team_key = crate::apis::urlencode(p_team_key),
        media_tag = crate::apis::urlencode(p_media_tag)
    );
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_team_media_by_tag_year(
    configuration: &configuration::Configuration,
    team_key: &str,
    media_tag: &str,
    year: i32,
) -> Result<Vec<models::Media>, Error<GetTeamMediaByTagYearError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_team_key = team_key;
    let p_media_tag = media_tag;
    let p_year = year;
...
pub async fn get_team_media_by_year(
    configuration: &configuration::Configuration,
    team_key: &str,
    year: i32,
) -> Result<Vec<models::Media>, Error<GetTeamMediaByYearError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_team_key = team_key;
    let p_year = year;
...
pub async fn get_team_robots(
    configuration: &configuration::Configuration,
    team_key: &str,
) -> Result<Vec<models::TeamRobot>, Error<GetTeamRobotsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_team_key = team_key;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => {
                return Err(Error::from(serde_json::Error::custom(
                    "Received `text/plain` content type response that cannot be converted to `Vec&lt;models::TeamRobot&gt;`",
                )));
            }
            ContentType::Unsupported(unknown_type) => {
                return Err(Error::from(serde_json::Error::custom(format!(
                    "Received `{unknown_type}` content type response that cannot be converted to `Vec&lt;models::TeamRobot&gt;`"
                ))));
            }
        }
    } else {
...
pub async fn get_team_simple(
    configuration: &configuration::Configuration,
    team_key: &str,
) -> Result<models::TeamSimple, Error<GetTeamSimpleError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_team_key = team_key;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => {
                return Err(Error::from(serde_json::Error::custom(
                    "Received `text/plain` content type response that cannot be converted to `models::TeamSimple`",
                )));
            }
            ContentType::Unsupported(unknown_type) => {
                return Err(Error::from(serde_json::Error::custom(format!(
                    "Received `{unknown_type}` content type response that cannot be converted to `models::TeamSimple`"
                ))));
            }
        }
    } else {
...
pub async fn get_team_social_media(
    configuration: &configuration::Configuration,
    team_key: &str,
) -> Result<Vec<models::Media>, Error<GetTeamSocialMediaError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_team_key = team_key;
...
/// competition.
pub async fn get_team_years_participated(
    configuration: &configuration::Configuration,
    team_key: &str,
) -> Result<Vec<i32>, Error<GetTeamYearsParticipatedError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_team_key = team_key;
...
pub async fn get_teams(
    configuration: &configuration::Configuration,
    page_num: i32,
) -> Result<Vec<models::Team>, Error<GetTeamsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
/// groups of 500.
pub async fn get_teams_by_year(
    configuration: &configuration::Configuration,
    year: i32,
    page_num: i32,
) -> Result<Vec<models::Team>, Error<GetTeamsByYearError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_year = year;
    let p_page_num = page_num;
...
/// of 500.
pub async fn get_teams_by_year_keys(
    configuration: &configuration::Configuration,
    year: i32,
    page_num: i32,
) -> Result<Vec<String>, Error<GetTeamsByYearKeysError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_year = year;
    let p_page_num = page_num;
...
pub async fn get_teams_by_year_simple(
    configuration: &configuration::Configuration,
    year: i32,
    page_num: i32,
) -> Result<Vec<models::TeamSimple>, Error<GetTeamsByYearSimpleError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_year = year;
    let p_page_num = page_num;
...
pub async fn get_teams_simple(
    configuration: &configuration::Configuration,
    page_num: i32,
) -> Result<Vec<models::TeamSimple>, Error<GetTeamsSimpleError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_page_num = page_num;
