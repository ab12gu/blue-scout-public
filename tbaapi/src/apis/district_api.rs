...
pub async fn get_district_history(configuration: &configuration::Configuration, district_abbreviation: &str) -> Result<Vec<models::DistrictList>, Error<GetDistrictHistoryError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn get_districts_by_year(configuration: &configuration::Configuration, year: i32) -> Result<Vec<models::DistrictList>, Error<GetDistrictsByYearError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_year = year;
